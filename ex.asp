<%
Dim addSQL
Dim add_id, add_pw, add_name, add_gender, add_birth, add_email1, add_email2, add_phone1, add_phone2, add_phone3, add_zip1, add_zip2, add_zip3, add_zip4, add_my
...
addSQL = "INSERT INTO ex1table (db_id, db_pw, db_name, db_gender, db_birth, db_email1, db_email2, db_phone1, db_phone2, db_phone3, db_zip1, db_zip2, db_zip3, db_zip4, db_my) values"
addSQL = addSQL & "('" & add_id & "','" & add_pw & "','" & add_name & "','" & add_gender & "','" & add_birth & "','" & add_email1 & "','" & add_email2 & "','" & add_phone1 & "','" & add_phone2 & "','" & add_phone3 & "','" & add_zip1 & "','" & add_zip2 & "','" & add_zip3 & "','" & add_zip4 & "','" & add_my & "');"
